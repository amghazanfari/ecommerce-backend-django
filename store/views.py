...
from store.models import Category, Product, Gallery, Specification, Size,\
      Color, Cart, CartOrder, CartOrderItem, ProductFaq, Review, WhishList,\
          Notification, Coupon, Tax
    ...
    def create(self, request):
        ...
        for c in cart_items:
            CartOrderItem.objects.create(
                order=order,
                item_product=c.cart_product,
                item_vendor=c.cart_product.product_vendor,
                qty=c.qty,
                color=c.color,
                size=c.size,
                price=c.price,
            ...
            order.cart_order_vendor.add(c.cart_product.product_vendor)
