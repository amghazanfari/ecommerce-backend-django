    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('old_price', models.DecimalField(decimal_places=0, default=0.0, max_digits=20)),
                ...
                ('pid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefghijklmnopqrtuvwxyz', length=10, max_length=20, prefix='', unique=True)),
                ('slug', models.SlugField(unique=True)),
